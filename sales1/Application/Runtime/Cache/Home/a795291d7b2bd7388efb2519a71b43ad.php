...
<div class="banner">
    <ul class="banner_pic" id="banner_pic">
        <li class="current"><img class="one" src="/Public/Home/images/17.jpg" width="1300" height="530"/></li>
        <li class="pic"><img class="one" src="/Public/Home/images/18.jpg" width="1300" height="530"/></li>
	    <li class="pic"><img class="one" src="/Public/Home/images/19.jpg" width="1300" height="530"/></li>
        <li class="pic"><img class="one" src="/Public/Home/images/20.png" width="1300" height="530"/></li>
         <li class="pic"><img class="one" src="/Public/Home/images/21.jpg" width="1300" height="530"/></li>
          <li class="pic"><img class="one" src="/Public/Home/images/22.png" width="1300" height="530"/></li>
	 </ul>
	  <ol id="button">
         <li class="current"></li>
 	     <li class="but"></li>
...
<div class="title">
    <i class="book"></i>
    <span style="font-size:25px;">热销图书</span>
</div><br />
<div class="span">
